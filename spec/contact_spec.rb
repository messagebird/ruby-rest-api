...
describe 'Contact' do
  ...
  it 'lists' do
    ...
    expect(http_client)
      ...
      .and_return('{"offset": 0,"limit": 20,"count": 2,"totalCount": 2,"links": {"first": "https://rest.messagebird.com/contacts?offset=0","previous": null,"next": null,"last": "https://rest.messagebird.com/contacts?offset=0"},"items": [{"id": "first-id","href": "https://rest.messagebird.com/contacts/first-id","msisdn": 31612345678,"firstName": "Foo","lastName": "Bar","custom_details": {"custom1": null,"custom2": null,"custom3": null,"custom4": null},"groups": {"totalCount": 0,"href": "https://rest.messagebird.com/contacts/first-id/groups"},"messages": {"totalCount": 0,"href": "https://rest.messagebird.com/contacts/first-id/messages"},"created_datetime": "2018-07-13T10:34:08+00:00","updatedDatetime": "2018-07-13T10:34:08+00:00"},{"id": "second-id","href": "https://rest.messagebird.com/contacts/second-id","msisdn": 49612345678,"firstName": "Hello","lastName": "World","custom_details": {"custom1": null,"custom2": null,"custom3": null,"custom4": null},"groups": {"totalCount": 0,"href": "https://rest.messagebird.com/contacts/second-id/groups"},"messages": {"totalCount": 0,"href": "https://rest.messagebird.com/contacts/second-id/messages"},"created_datetime": "2018-07-13T10:33:52+00:00","updatedDatetime": null}]}')
    ...
    expect(list.total_count).to eq 2
  ...
  it 'reads an existing' do
    ...
    expect(http_client)
      ...
      .and_return('{"id": "contact-id","href": "https://rest.messagebird.com/contacts/contact-id","msisdn": 31612345678,"firstName": "Foo","lastName": "Bar","custom_details": {"custom1": "First","custom2": "Second","custom3": "Third","custom4": "Fourth"},"groups": {"totalCount": 3,"href": "https://rest.messagebird.com/contacts/contact-id/groups"},"messages": {"totalCount": 5,"href": "https://rest.messagebird.com/contacts/contact-id/messages"},"created_datetime": "2018-07-13T10:34:08+00:00","updatedDatetime": "2018-07-13T10:44:08+00:00"}')

    contact = client.contact('contact-id')

    expect(contact.id).to eq 'contact-id'
    expect(contact.msisdn).to eq 31_612_345_678
  end
  ...
  it 'reads custom details' do
    ...
    expect(contact.custom_details).to be_an_instance_of(MessageBird::CustomDetails)

    expect(contact.custom_details.custom1).to eq 'First'
    expect(contact.custom_details.custom4).to eq 'Fourth'
  end
  ...
  it 'lists groups' do
    ...
    expect(contact.groups.total_count).to eq 3
  end
  ...
  it 'lists messages' do
    ...
    expect(contact.messages.total_count).to eq 5
  end
end
